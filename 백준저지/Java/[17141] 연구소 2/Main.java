// 백준저지 17141번 연구소 2 https://www.acmicpc.net/problem/17141
...
public class Main {
    ...
    private static int spreadVirus(int[] selected) { // 선택된 바이러스를 가지고 퍼뜨리기 (BFS)
        ...
        return cnt - 1; // 여기까지 오면 여태까지 나온 값 중 최솟값이기 때문에 cnt 리턴
    }
}
